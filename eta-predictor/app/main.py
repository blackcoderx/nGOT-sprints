"""FastAPI application — ETA Predictor API entry point."""
...
START_TIME = time.time()  # used for uptime calculation in health checks


# @app.on_event('startup') runs once when the server starts — replaces __init__ side effects
